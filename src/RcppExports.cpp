...
// discretize_df_cpp
NumericMatrix discretize_df_cpp(DataFrame data, NumericVector dims, NumericVector x_range, NumericVector y_range);
RcppExport SEXP _attractor_discretize_df_cpp(SEXP dataSEXP, SEXP dimsSEXP, SEXP x_rangeSEXP, SEXP y_rangeSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< DataFrame >::type data(dataSEXP);
    ...
    Rcpp::traits::input_parameter< NumericVector >::type x_range(x_rangeSEXP);
    Rcpp::traits::input_parameter< NumericVector >::type y_range(y_rangeSEXP);
    rcpp_result_gen = Rcpp::wrap(discretize_df_cpp(data, dims, x_range, y_range));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_attractor_discretize_df_cpp", (DL_FUNC) &_attractor_discretize_df_cpp, 4},
